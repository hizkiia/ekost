                ...
                <nav id="main_menu" class="mobile_menu navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown simple_menu active">
                            <a href="#" class="" data-toggle="dropdown">HOME <b class="caret"></b></a>
                            <a href=""></a>

                        </li>
                        <li class="dropdown simple_menu">
                            <a href="#" class="" data-toggle="dropdown">ROOMS <b class="caret"></b></a>
                        </li>
                ...
                <ul>
                    ...
                    <li data-transition="crossfade">
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             style="z-index: 5; color: #fff; font-weight: 900;"> WELCOME TO EUFORIAHOME </div>
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption tp-resizeme" 
                             data-x="center" 
                             data-hoffset="" 
                             ...
                             style="z-index: 6; color: #fff;">Life Balance in Perfection</div>
                        <!-- LAYER NR. 3 -->
                       ...
                       <a class="tp-caption button btn_blue" 
                          ...
                          style="z-index: 11;"><i class="fa fa-calendar"></i>REGISTERS
                        </a>
                       <!-- LAYER NR. 8 -->
                    ...
                    <li data-transition="crossfade">
                        ...
                        <div class="tp-caption tp-resizeme"
                             ...
                             data-whitespace="nowrap"
                             data-frames='[{"delay":1500,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                             style="z-index: 6; color: #fff;">Private Space for Your Freedom
                        </div>
                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme" 
                             data-x="center" 
                    ...
                    <li data-transition="crossfade">
                        ...
                        <div class="tp-caption tp-resizeme" 
                             ...
                             style="z-index: 5; color: #fff; font-weight: 900;">Exclusive Kost: The Comfort of Staying Like Home
                        </div>
                        <!-- LAYER NR. 2 -->
                        <div class="tp-caption tp-resizeme" 
                             data-x="center" 
                             ...
                             data-whitespace="nowrap"
                             data-frames='[{"delay":1500,"speed":1500,"frame":"0","from":"y:[100%];z:0;rX:0deg;rY:0;rZ:0;sX:1;sY:1;skX:0;skY:0;opacity:0;","mask":"x:0px;y:[100%];s:inherit;e:inherit;","to":"o:1;","ease":"Power2.easeInOut"},{"delay":"wait","speed":500,"frame":"999","to":"auto:auto;","ease":"Power3.easeInOut"}]'
                             style="z-index: 6; color: #fff;">starting from 500k thousand rupiah 
                        </div>
                        <!-- LAYER NR. 3 -->
                        <div class="tp-caption tp-shape tp-shapewrapper tp-resizeme" 
                             data-x="center" 
