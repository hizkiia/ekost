            ...
            <div class="inner">
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="price">
                            <div class="inner">
                                Rp1.300.000 <span>per months</span>
                            </div>
                        </div>
                    </div>
                </div>
